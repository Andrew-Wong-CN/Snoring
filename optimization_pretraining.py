...
from models.sound_stage_net_v2 import PreTrainingNet
...
model.load_state_dict(torch.load("parameters/pretraining_SSNV2.pth"))
model.to(device)
...
if __name__ == "__main__":
    main()
    save_path = "parameters/pretraining_SSNV2.pth"
